...
path_to_save_pdf = 'C:\\IonIdea\\County_Downloaded_Documents\\MA-ESSEX'
...
url="https://search.lawrencedeeds.com/ALIS/WW400R.HTM?WSIQTP=SY00"
browser.get(url)
browser.maximize_window()

# Registry records - MORTGAGE
time.sleep(4)
registry = browser.find_element(By.XPATH,"/html/body/div/div[2]/div/div[4]/div/div[3]/div[2]/div[2]/div/a").click()
