...
path_to_save_pdf = 'C:\\IonIdea\\County_Downloaded_Documents\\NY-QUEENS'
...
borough.select_by_visible_text("QUEENS")
...
# edit
time.sleep(2)
edit = browser.find_element(By.XPATH,"//form[@name='DATA']/table/tbody/tr/td/font/font[3]/a[3]").click()
