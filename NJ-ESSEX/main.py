...
path_to_save_pdf = 'C:\\IonIdea\\County_Downloaded_Documents\\NJ-ESSEX'
...
url = "https://press.essexregister.com/prodpress/index.aspx"
browser.get(url)
browser.maximize_window()

# public records search
sleep(4)
records = browser.find_element(By.XPATH, "//input[@id='imgBtnClickHerePublicRecordSearch']").click()

# Go to Document Search page and fill in details
sleep(5)
browser.find_element(By.XPATH, "//a[contains(text(),'By Document Type')]").click()
sleep(2)
...
for doc in doc_types:
    ...
    total.select_by_visible_text('750')
    sleep(2)
