...
path_to_save_pdf = 'C:\\IonIdea\\County_Downloaded_Documents\\TX-PARKER'
...
url = "https://parkercountytx-web.tylerhost.net/web/user/disclaimer"
browser.get(url)
...
time.sleep(3)
browser.execute_script("window.scrollBy(0,420)", "")
...
document_number = []
for d in ids:
    document_number.append(d.text[0:9])
