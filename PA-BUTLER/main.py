...
path_to_save_pdf = 'C:\\IonIdea\\County_Downloaded_Documents\\PA-BUTLER'
...
url = "http://www2.co.butler.pa.us/recorder/"
browser.get(url)
...
time.sleep(3)
mortgage = browser.find_element(By.XPATH, "//div[@id='jstreeCatDocTypes']/ul/li[4]/ul/li[6]/a/i[1]").click()
time.sleep(3)
mortgage_1 = browser.find_element(By.XPATH, "//div[@id='jstreeCatDocTypes']/ul/li[4]/ul/li[9]/a/i[1]").click()
time.sleep(3)
mortgage_2 = browser.find_element(By.XPATH, "//div[@id='jstreeCatDocTypes']/ul/li[4]/ul/li[10]/a/i[1]").click()
...
mortgage = browser.find_element(By.XPATH, "//div[@id='jstreeCatDocTypes']/ul/li[4]/ul/li[10]/a/i[1]").click()
time.sleep(3)
mortgage_1 = browser.find_element(By.XPATH, "//div[@id='jstreeCatDocTypes']/ul/li[4]/ul/li[9]/a/i[1]").click()
time.sleep(3)
mortgage_2 = browser.find_element(By.XPATH, "//div[@id='jstreeCatDocTypes']/ul/li[4]/ul/li[6]/a/i[1]").click()
time.sleep(3)
doc_types_drop_down = browser.find_element(By.XPATH, "//div[@id='jstreeCatDocTypes']/ul/li[4]/i").click()
...
time.sleep(3)
deed = browser.find_element(By.XPATH, "//div[@id='jstreeCatDocTypes']/ul/li[1]/ul/li[31]/a/i[1]").click()
time.sleep(3)
