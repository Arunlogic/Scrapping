...
path_to_save_pdf = 'C:\\IonIdea\\County_Downloaded_Documents\\MA-NANTUCKET'
...
url = "http://www.masslandrecords.com/Nantucket/"
browser.get(url)
...
try:
    alert = WebDriverWait(browser, 5).until(
        EC.presence_of_element_located((By.ID, 'MessageBoxCtrl1_buttonmbatCLIENTOK')))
