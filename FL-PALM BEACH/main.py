...
path_to_save_pdf = "C:\\IonIdea\\County_Downloaded_Documents\\FL-PALM BEACH"
...
time.sleep(4)
mortgage = browser.find_element(By.XPATH, "//input[@id='dt-DocumentType-50']").click()
time.sleep(3)
m_1 = browser.find_element(By.XPATH, "//input[@id='dt-DocumentType-325']").click()
time.sleep(3)
m_2 = browser.find_element(By.XPATH, "//input[@id='dt-DocumentType-11']").click()
time.sleep(3)
m_3 = browser.find_element(By.XPATH, "//input[@id='dt-DocumentType-13']").click()
time.sleep(3)
m_4 = browser.find_element(By.XPATH, "//input[@id='dt-DocumentType-314']").click()
...
# Selecting deed
deed = browser.find_element(By.XPATH, "//input[@id='dt-DocumentType-25']").click()
