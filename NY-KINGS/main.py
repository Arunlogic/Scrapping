...
path_to_save_pdf = 'C:\\IonIdea\\County_Downloaded_Documents\\NY-KINGS'
...
borough.select_by_visible_text("BROOKLYN / KINGS")
...
while True:
    ...
    for i in range(len(a)):
        img = browser.find_element(By.XPATH,f"//form[@name='DATA']/table/tbody/tr[2]/td/table/tbody/tr[{i + 2}]/td/div/font/input[2]")
        img.click()
        time.sleep(4)
...
# edit
time.sleep(2)
edit = browser.find_element(By.XPATH,"//form[@name='DATA']/table/tbody/tr/td/font/font[2]/a[3]").click()
