...
path_to_save_pdf = 'C:\\IonIdea\\County_Downloaded_Documents\\NC-FRANKLIN'
...
url="http://72.15.246.186/franklinnc/"
browser.get(url)
...
grantor = browser.find_element(By.XPATH, "//input[@id='searchtype'][1]").click()
time.sleep(2)
# advance search
'''
time.sleep(2)
...
time.sleep(2)
instrument.deselect_by_visible_text('AFFIDAVIT')
time.sleep(2)
instrument.select_by_visible_text('DEED OF TRUST')
time.sleep(2)
instrument.select_by_visible_text('MTG')
time.sleep(2)
instrument.select_by_visible_text('S/INS')
...
time.sleep(5)
# display_documents = browser.find_element(By.XPATH,"//img[@title='Click this button to display documents for the parties you have selected']").click()
unique = browser.find_element(By.XPATH, "//div[@id='pagingElements2']/div[1]/span/span[5]/a/img").click()
# download
...
while True:
    try:
        ...
        for r in records:
            ...
            download = browser.find_element(By.XPATH, "//a[contains(text(),'Download Image')]").click()
            time.sleep(8)
            browser.switch_to.default_content()
            back = browser.find_element(By.XPATH, "//a[contains(text(),'Consolidated Index')]").click()
            time.sleep(3)
        browser.switch_to.frame(browser.find_element(By.ID, 'tabframe0'))
...
browser.switch_to.frame(browser.find_element(By.ID, 'tabframe0'))
time.sleep(2)
grantee = browser.find_element(By.XPATH, "//input[@id='searchtype'][2]").click()
time.sleep(2)
instrument.deselect_by_visible_text('DEED OF TRUST')
time.sleep(1)
instrument.deselect_by_visible_text('MTG')
time.sleep(2)
instrument.deselect_by_visible_text('S/INS')
time.sleep(2)
